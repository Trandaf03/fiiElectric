...
public class pagina_masini_avantaje extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pagina_masini_avantaje);
        ...
        String textavantaj1 = "<h1>✦ Costurile energiei electrice:</h1> <p>la momentul actual, mașinile electrice nu domină încă piața auto," +
                ...
                " o cantitate care sigur nu vă asigură autonomia unui „plin” cu o mașină electrică.</p>";
        String textavantaj2 = "<h1>✦ Întreținere ieftină:</h><p> datorită faptului că autovehiculele electrice au mai puține piese în mișcare și anexe" +
                ...
                "va fi neglijabilă, mai ales dacă circulați mult (40-50.000km/an), costul acesteia amortizându-se cu economia de combustibil.</p>";
        String textavantaj3 = "<h1>✦ Contribuția la un viitor mai curat:</h><p> chiar dacă există anumite controverse legate de modalitatea de producție " +
                ...
                "dacă este obținută prin mijloace eco-friendly, mult mai ecologică.</p>";
        String textavantaj4 = "<h1>✦ Mai puțină poluare fonică:</h><p> unii dintre noi sunt pasionați de „mormăitul” grav al unui motor Diesel sau de tonalitatea" +
                ...
                " activate la viteze reduse pentru a avertiza pietonii.</p>";
        String textavantaj5 = "<h1>✦ Reduceri de preț, taxe și cool-factor:</h><p> dacă decideți să achiziționați un autoturism electric nou, prin programul Rabla" +
                ...
                "vă doriți să ieșiți în evidență fără să cheltuiți mai mult de 20.000 €, autovehiculele electrice ar trebui să se afle printre opțiunile dumneavoastră.</p>";
